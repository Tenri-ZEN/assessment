...
assessmentButton.addEventListener(
  ...
  function(){
   ...
   //診断結果表示エリアの作成
   resultDivision.innerText = ''//divタグを空文字列で上書きすることで空にしている
   ...
   //headeDivisionとbodyDivisionをresultDivisionに差し込む
   ...
   resultDivision.appendChild(bodyDivision)
    ...
    const hrefValue = 'https://x.com/intent/tweet?button_hashtag='+encodeURIComponent('神楽叶からの誉め言葉')+
    '&ref_src=twsrc%5Etfw'
